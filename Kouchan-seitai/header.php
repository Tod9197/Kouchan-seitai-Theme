...
<head>
  ...
  <link rel="stylesheet" href="<?php echo esc_url(get_theme_file_uri('/css/access.css')); ?>" type="text/css">
  <link rel="stylesheet" href="<?php echo esc_url(get_theme_file_uri('/css/voices.css')); ?>" type="text/css">
